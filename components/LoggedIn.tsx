    ...
    return (
        <div className="inline-flex">
            <Link href="/api/logout">
                <button className="font-semibold py-2 pr-3 px-4 rounded-full mr-1 inline-flex items-center text-white bg-bgDark focus:outline-none">
                    <img
            ...
            <Link href={`/history/user/${data.id}`}>
                <button className="font-semibold py-2 pr-3 px-4 rounded-full mr-1 inline-flex items-center text-white bg-bgDark focus:outline-none">
                    <div className="mr-2 ml-[-0.6rem] mt-[-100%] mb-[-100%] translate-y-[0.05rem]">
                        {/* @ts-ignore */}
