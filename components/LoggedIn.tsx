import {faClockRotateLeft, faArrowRightFromBracket} from "@fortawesome/free-solid-svg-icons";
...
export default function LoggedIn({ data }) {
    return (
        <div className="inline-flex">
            <button className="cursor-default font-semibold py-2 pr-[0.95rem] px-4 rounded-full mr-1 inline-flex items-center text-white bg-bgDark focus:outline-none">
                <img
                ...
                <span>
                    ...
                    {data ? (
                        <Link href="/api/logout">
                            <FontAwesomeIcon icon={faArrowRightFromBracket} size="lg" className="text-red-400 cursor-pointer pl-2 translate-y-[0.05rem]"/>
                        </Link>
                    ) : ""}
                </span>
            </button>
