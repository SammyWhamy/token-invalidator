...
export default function Form({ data }) {
    return (
        <div className='h-screen relative bg-gradient-to-br from-blue-101 to-fuchsia-101 overflow-hidden'>
            <div className='w-11/12 md:w-3/6 2xl:w-6/12 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 backdrop-blur-10px bg-gray-700/30 backdrop-opacity-xl rounded-3xl md:p-20 p-10'>
